...
class HRDashboardWindow(QMainWindow):
    def __init__(self):
        ...
        # Sidebar
        sidebar_icons = {"Dashboard": resource_path("assets/icons/dollar-sign.svg"),
                         "Employees": resource_path("assets/icons/users.svg"),
                         "Settings": resource_path("assets/icons/settings.svg")
        }
